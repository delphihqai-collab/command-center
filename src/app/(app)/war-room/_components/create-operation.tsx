        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="e.g. Sprint to close Q1 deals"
              className="mt-1 border-zinc-800 bg-zinc-900 text-zinc-50"
            />
          </div>
          <div>
            <label className="text-xs font-medium text-zinc-400">Linked Deal (optional)</label>
            <select
              value={leadId}
            ...
            >
              ...
              {leads.map((lead) => (
                <option key={lead.id} value={lead.id}>
                  {lead.company_name}
                  {lead.deal_value_eur ? ` (\u20AC${lead.deal_value_eur.toLocaleString()})` : ""}{" "}
          ...
          <div>
            <label className="text-xs font-medium text-zinc-400">Objective</label>
            <textarea
              value={objective}
              onChange={(e) => setObjective(e.target.value)}
              placeholder="What should this operation achieve?"
              rows={2}
          ...
          <div>
            <label className="text-xs font-medium text-zinc-400">Team</label>
