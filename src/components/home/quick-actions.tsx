...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  },
  {
    ...
    needsInput: true,
    inputPlaceholder: "e.g. Clinica Dental Porto",
    defaultMessage:
...
const GROUP_ORDER: QuickAction["group"][] = [
  "prospect",
  "build",
  "outreach",
  "monitor",
...
export function QuickActions() {
  ...
  function handleExecute(action: QuickAction, input?: string) {
    startTransition(async () => {
      ...
      // Open Hermes chat drawer to see the response
      window.dispatchEvent(new CustomEvent("open-hermes"));
    });
  }
