...
const nextConfig: NextConfig = {
  ...
  // No redirects — old pages still exist and work alongside new V10 pages.
  // Sidebar links to new pages only (/, /pipeline, /fleet, /system).
  // Old page directories will be removed in a future cleanup pass.
};
